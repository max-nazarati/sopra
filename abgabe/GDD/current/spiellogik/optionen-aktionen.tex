...
\begin{longtabu}{X[0.6L]X[0.4L]X[L]X[L]X[L]}
  ...
  \defid[put-defend]{Gebäude platzieren}
    ...
    & Der Spieler hat eine gültige Gebäudeplatzierung gewählt
      (\refid{A:choose-position}) und genügend Bitcoin um das Gebäude zu kaufen.
  ...
  \defid[tower-improve]{Gebäude verbessern}
    ...
    & \vspace*{-0.2cm}\begin{enumerate}[nosep, leftmargin=*]
        ...
        \item Die Verbesserungskosten werden vom Bitcoin des Spielers abgezogen.
        \item Der Turm wird verbessert.
      \end{enumerate}
    & Ein eigenes Gebäude ist ausgewählt und Spieler hat genügend Bitcoin.
    & Der ausgewählte Turm wurde verbessert und das Bitcoin abgezogen.
  \\\midrule
